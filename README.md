...
<p align="center">
  <picture>
    <source media="(max-width: 760px) and (prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-bfe5d33c-mobile-dark.svg">
    <source media="(max-width: 760px)" srcset="./assets/hero/agent-console-bfe5d33c-mobile-light.svg">
    <source media="(prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-bfe5d33c-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="./assets/hero/agent-console-bfe5d33c-light.svg">
    <img src="./assets/hero/agent-console-bfe5d33c-dark.svg" alt="Ecclesiates Natarios Sihombing - CS - SE Student & HIMTI Activist" width="100%">
  </picture>
</p>
